...
public class FahadCustomImageView extends ImageView {
	...
	public FahadCustomImageView(Context context) {
		this(context, null);
	}

	public FahadCustomImageView(Context context, AttributeSet attrs) {
