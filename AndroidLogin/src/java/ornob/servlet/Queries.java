...
public class Queries {
	public static final String UPDATE_CREATOR_QUERY = "UPDATE user SET user_name = ?, address = ?, email = ?, phn_no = ?, latitude = ?, longitude = ?, creator_type_id = ? ,image_url =? WHERE user_id = ?";
