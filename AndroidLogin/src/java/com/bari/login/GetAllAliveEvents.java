 ...
 * @author Fahad_G4
 */
@WebServlet(name = "GetAllAliveEvents", urlPatterns = {"/GetAllAliveEvents"})
public class GetAllAliveEvents extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet GetAllAliveEvent at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
